...
function StockThree() {
    ...
    return(
        <>
        <Frontpage/>
        <h1 style={{color: "black", textAlign : "center",backgroundColor: "white"}}>Stock 3 Price Data</h1>
        ...
        <div style={{backgroundColor: "white", width : "80%",margin : "0 10%"}} >
            ...
            <h1 style={{color: "black", textAlign : "center",backgroundColor: "white"}}>Stock 3 Social Media Data</h1>
